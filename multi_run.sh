...
do  
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_ABL_ALL}; sleep 20;
done
#
USE_STATE_ABS=False
...
do
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_Q2}; sleep 20;
done
...
do
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_Q3}; sleep 20;
done
...
do
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_Q4}; sleep 20;
done
...
do
    ...
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_Q5}; sleep 20;
done
...
${runner} gpu_run.sh ${RL_TRAIN_CMD_TEST}; sleep 20;
...
for Q in 0.2 0.4 0.6 0.8 
do
    ${runner} gpu_run.sh ${RL_TRAIN_CMD_TEST2}; sleep 20;
done
done
